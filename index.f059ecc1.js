let e,t,i,n,a,o,r,s;var l,c,f,d,u,p,h,m,g,y="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},b={},w={},v=y.parcelRequired7c6;null==v&&((v=function(e){if(e in b)return b[e].exports;if(e in w){var t=w[e];delete w[e];var i={id:e,exports:{}};return b[e]=i,t.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){w[e]=t},y.parcelRequired7c6=v),v("7Y9D8"),v("5Szup");const x={el:document.querySelector(".btn-up"),show(){this.el.classList.remove("btn-up_hide")},hide(){this.el.classList.add("btn-up_hide")},addEventListener(){window.addEventListener("scroll",()=>{let e=window.scrollY||document.documentElement.scrollTop;e>400?this.show():this.hide()}),document.querySelector(".btn-up").onclick=()=>{window.scrollTo({top:0,left:0,behavior:"smooth"})}}};x.addEventListener();var I=v("2shzp"),k={};f=void 0!==y?y:"undefined"!=typeof window?window:k,d=function(e){// COMMON: SSR check: begin
...
var h={};"object"==typeof c?h=c:"object"==typeof d&&(h=d),// extend new settings with the new options
t=s(!0,t,h)}// check callbackOrOptions and options: end
// notify type
var m=t[a.toLocaleLowerCase("en")];// notify counter
f++,"string"!=typeof r&&(r="Notiflix "+a),t.plainText&&(r=l(r)),!t.plainText&&r.length>t.messageMaxLength&&(// extend settings for error massege
...
if(t.showOnlyTheLastOne&&f>0)for(var D=e.document.querySelectorAll("[id^="+t.ID+"-]:not([id="+t.ID+"-"+f+"])"),T=0;T<D.length;T++){var _=D[T];null!==_.parentNode&&_.parentNode.removeChild(_)}// notify - show only the last one: end
...
info:function(e,t,n){d(i.Info,e,t,n)}}};return"object"==typeof e.Notiflix?s(!0,e.Notiflix,{Notify:u.Notify}):{Notify:u.Notify}},"function"==typeof define&&define.amd?define([],function(){return d(f)}):"object"==typeof k?k=d(f):f.Notiflix=d(f);const E=document.querySelector(".categories-list");async function N(){let{data:e}=await (0,I.default).get("https://books-backend.p.goit.global/books/category-list");return e}(async function e(){try{let e=await N();if(!e.length){(0,k.Notify).failure("Oops something going wrong.");return}E.insertAdjacentHTML("beforeend",e.map(({list_name:e})=>`
    <li class="categories-list-item">
      <a href="" class="categories-link">${e}</a>
    </li>
  `).join(""))}catch(e){console.log("TRY-CATCH:",e),(0,k.Notify).failure("Oops something going wrong.")}})(),E.addEventListener("click",e=>{e.preventDefault()}),v("fewGv");const S=(e,t)=>{try{let i=JSON.stringify(t);localStorage.setItem(e,i)}catch(e){console.error("Set state error: ",e.message)}},C=e=>{try{let t=localStorage.getItem(e);return null===t?void 0:JSON.parse(t)}catch(e){console.error("Get state error: ",e.message)}};var I=v("2shzp");async function D(){console.log("get api");try{let e=await (0,I.default).get("https://books-backend.p.goit.global/books/top-books");return console.log("succsess"),e.data}catch(e){console.error("An error occurred while fetching data:",e)}}const T=document.querySelector(".common-list");let _=window.innerWidth<767?1:window.innerWidth<1439?3:5;function A(e){let t="";for(let i of e){let{books:e,list_name:n}=i;t+=` 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q=function(e){// TODO(user): Use native implementations if/when available
...
a=65536+((1023&a)<<10)+(1023&e.charCodeAt(++n)),t[i++]=a>>18|240,t[i++]=a>>12&63|128):t[i++]=a>>12|224,t[i++]=a>>6&63|128),t[i++]=63&a|128)}return t},Z=function(e){// TODO(user): Use native implementations if/when available
...
let o=e[i++],r=e[i++],s=e[i++],l=((7&a)<<18|(63&o)<<12|(63&r)<<6|63&s)-65536;t[n++]=String.fromCharCode(55296+(l>>10)),t[n++]=String.fromCharCode(56320+(1023&l))}else{let o=e[i++],r=e[i++];t[n++]=String.fromCharCode((15&a)<<12|(63&o)<<6|63&r)}}return t.join("")},X={/**
     ...
     */encodeByteArray(e,t){if(!Array.isArray(e))throw Error("encodeByteArray takes an array as a parameter");this.init_();let i=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,n=[];for(let t=0;t<e.length;t+=3){let a=e[t],o=t+1<e.length,r=o?e[t+1]:0,s=t+2<e.length,l=s?e[t+2]:0,c=a>>2,f=(3&a)<<4|r>>4,d=(15&r)<<2|l>>6,u=63&l;s||(u=64,o||(d=64)),n.push(i[c],i[f],i[d],i[u])}return n.join("")},/**
...
// a native base64 encoder in the form of "btoa/atob"
this.HAS_NATIVE_SUPPORT&&!t?atob(e):Z(this.decodeStringToByteArray(e,t)))},/**
     * Base64-decode a string.
     *
 ...
 */const et=function(e){let t=Q(e);return X.encodeByteArray(t,!0)},ei=function(e){// Use base64url encoding and remove padding in the end (dot characters).
return et(e).replace(/\./g,"")},en=function(e){try{return X.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null},ea=()=>/**
 * @license
 ...
 */function ef(){try{return"object"==typeof indexedDB}catch(e){return!1}}/**
 * This method validates browser/sw context for indexedDB by opening a dummy indexedDB database and reject
 * if errors occur during the database open operation.
 *
 * @throws exception if current browser/sw context can't run idb.open (ex: Safari iframe, Firefox
 * private browsing)
 */function ed(){return new Promise((e,t)=>{try{let i=!0,n="validate-browser-context-for-indexeddb-analytics-module",a=self.indexedDB.open(n);a.onsuccess=()=>{a.result.close(),i||self.indexedDB.deleteDatabase(n),e(!0)},a.onupgradeneeded=()=>{i=!1},a.onerror=()=>{var e;t((null===(e=a.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}})}// Based on code from:
 ...
 */const ek=[];(u=g||(g={}))[u.DEBUG=0]="DEBUG",u[u.VERBOSE=1]="VERBOSE",u[u.INFO=2]="INFO",u[u.WARN=3]="WARN",u[u.ERROR=4]="ERROR",u[u.SILENT=5]="SILENT";const eE={debug:g.DEBUG,verbose:g.VERBOSE,info:g.INFO,warn:g.WARN,error:g.ERROR,silent:g.SILENT},eN=g.INFO,eS={[g.DEBUG]:"log",[g.VERBOSE]:"log",[g.INFO]:"info",[g.WARN]:"warn",[g.ERROR]:"error"},eC=(e,t,...i)=>{if(t<e.logLevel)return;let n=new Date().toISOString(),a=eS[t];if(a)console[a](`[${n}]  ${e.name}:`,...i);else throw Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class eD{/**
...
setLogLevel(e){this._logLevel="string"==typeof e?eE[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}/**
     ...
     */debug(...e){this._userLogHandler&&this._userLogHandler(this,g.DEBUG,...e),this._logHandler(this,g.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,g.VERBOSE,...e),this._logHandler(this,g.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,g.INFO,...e),this._logHandler(this,g.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,g.WARN,...e),this._logHandler(this,g.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,g.ERROR,...e),this._logHandler(this,g.ERROR,...e)}}const eT=(e,t)=>t.some(t=>e instanceof t),e_=new WeakMap,eA=new WeakMap,eL=new WeakMap,eB=new WeakMap,eO=new WeakMap;let eM={get(e,t,i){if(e instanceof IDBTransaction){// Special handling for transaction.done.
 ...
 * provider.
 */function(e){let t=e.getComponent();return(null==t?void 0:t.type)==="VERSION"/* ComponentType.VERSION */}(e))return null;{let t=e.getImmediate();return`${t.library}/${t.version}`}}).filter(e=>e).join(" ")}}const eR="@firebase/app",eq="0.9.18",eV=new eD("@firebase/app"),eU="[DEFAULT]",eK={[eR]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},eG=new Map,eJ=new Map;/**
 *
 ...
 *
 * @internal
 */function eQ(e,t){let i=e.container.getProvider("heartbeat").getImmediate({optional:!0});return i&&i.triggerHeartbeat(),e.container.getProvider(t)}const eZ=new ep("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class eX{constructor(e,t,i){this._isDeleted=!1,this._options=Object.assign({},e),this._config=Object.assign({},t),this._name=t.name,this._automaticDataCollectionEnabled=t.automaticDataCollectionEnabled,this._container=i,this.container.addComponent(new ew("app",()=>this,"PUBLIC"/* ComponentType.PUBLIC */))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this.checkDestroyed(),this._automaticDataCollectionEnabled=e}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(e){this._isDeleted=e}/**
     ...
     */checkDestroyed(){if(this.isDeleted)throw eZ.create("app-deleted"/* AppError.APP_DELETED */,{appName:this._name})}}function e0(e,t={}){let i=e;if("object"!=typeof t){let e=t;t={name:e}}let n=Object.assign({name:eU,automaticDataCollectionEnabled:!1},t),a=n.name;if("string"!=typeof a||!a)throw eZ.create("bad-app-name"/* AppError.BAD_APP_NAME */,{appName:String(a)});if(i||(i=el()),!i)throw eZ.create("no-options"/* AppError.NO_OPTIONS */);let o=eG.get(a);if(o){// return the existing app if options and config deep equal the ones in the existing app.
if(em(i,o.options)&&em(n,o.config))return o;throw eZ.create("duplicate-app"/* AppError.DUPLICATE_APP */,{appName:a})}let r=new eI(a);for(let e of eJ.values())r.addComponent(e);let s=new eX(i,n,r);return eG.set(a,s),s}/**
...
let a=null!==(n=eK[e])&&void 0!==n?n:e;i&&(a+=`-${i}`);let o=a.match(/\s|\//),r=t.match(/\s|\//);if(o||r){let e=[`Unable to register library "${a}" with version "${t}":`];o&&e.push(`library name "${a}" contains illegal characters (whitespace or "/")`),o&&r&&e.push("and"),r&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),eV.warn(e.join(" "));return}eY(new ew(`${a}-version`,()=>({library:a,version:t}),"VERSION"/* ComponentType.VERSION */))}const e2="firebase-heartbeat-store";let e9=null;function e3(){return e9||(e9=/**
 * Open a database.
 *
 * @param name Name of the database.
 * @param version Schema version.
 * @param callbacks Additional callbacks.
 */(function(e,t,{blocked:i,upgrade:n,blocking:a,terminated:o}={}){let r=indexedDB.open(e,1),s=ej(r);return n&&r.addEventListener("upgradeneeded",e=>{n(ej(r.result),e.oldVersion,e.newVersion,ej(r.transaction),e)}),i&&r.addEventListener("blocked",e=>i(e.oldVersion,e.newVersion,e)),s.then(e=>{o&&e.addEventListener("close",()=>o()),a&&e.addEventListener("versionchange",e=>a(e.oldVersion,e.newVersion,e))}).catch(()=>{}),s})("firebase-heartbeat-database",0,{upgrade:(e,t)=>{0===t&&e.createObjectStore(e2)}}).catch(e=>{throw eZ.create("idb-open"/* AppError.IDB_OPEN */,{originalErrorMessage:e.message})})),e9}async function e5(e){try{let t=await e3(),i=await t.transaction(e2).objectStore(e2).get(e4(e));return i}catch(e){if(e instanceof eu)eV.warn(e.message);else{let t=eZ.create("idb-get"/* AppError.IDB_GET */,{originalErrorMessage:null==e?void 0:e.message});eV.warn(t.message)}}}async function e8(e,t){try{let i=await e3(),n=i.transaction(e2,"readwrite"),a=n.objectStore(e2);await a.put(t,e4(e)),await n.done}catch(e){if(e instanceof eu)eV.warn(e.message);else{let t=eZ.create("idb-set"/* AppError.IDB_WRITE */,{originalErrorMessage:null==e?void 0:e.message});eV.warn(t.message)}}}function e4(e){return`${e.name}!${e.options.appId}`}class e6{constructor(e){this.container=e,/**
...
return e.toISOString().substring(0,10)}class te{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return!!ef()&&ed().then(()=>!0).catch(()=>!1)}/**
     * Read all heartbeats.
...
e1("fire-js",""),e1("firebase","10.3.1","app");const ti=(e,t)=>t.some(t=>e instanceof t),tn=new WeakMap,ta=new WeakMap,to=new WeakMap,tr=new WeakMap,ts=new WeakMap;let tl={get(e,t,i){if(e instanceof IDBTransaction){// Special handling for transaction.done.
...
// the original object.
t.apply(tf(this),e),tc(tn.get(this)))}:function(...e){// Calling the original function with the proxy as 'this' causes ILLEGAL INVOCATION, so we use
// the original object.
return tc(t.apply(tf(this),e))}:function(e,...i){let n=t.call(tf(this),e,...i);return to.set(n,e.sort?e.sort():[e]),tc(n)}:(t instanceof IDBTransaction&&function(e){// Early bail if we've already created a done promise for this transaction.
...
ta.set(e,t)}(t),ti(t,i||(i=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])))?new Proxy(t,tl):t;return a!==e&&(tr.set(e,a),ts.set(a,e)),a}const tf=e=>ts.get(e),td=["get","getKey","getAll","getAllKeys","count"],tu=["put","add","delete","clear"],tp=new Map;function th(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&"string"==typeof t))return;if(tp.get(t))return tp.get(t);let i=t.replace(/FromIndex$/,""),n=t!==i,a=tu.includes(i);if(!(i in(n?IDBIndex:IDBObjectStore).prototype)||!(a||td.includes(i)))return;let o=async function(e,...t){// isWrite ? 'readwrite' : undefined gzipps better, but fails in Edge :(
let o=this.transaction(e,a?"readwrite":"readonly"),r=o.store;// Must reject if op rejects.
// If it's a write operation, must reject if tx.done rejects.
// Must reject with op rejection first.
// Must resolve with op value.
// Must handle both promises (no unhandled rejections)
return n&&(r=r.index(t.shift())),(await Promise.all([r[i](...t),a&&o.done]))[0]};return tp.set(t,o),o}tl={...c=tl,get:(e,t,i)=>th(e,t)||c.get(e,t,i),has:(e,t)=>!!th(e,t)||c.has(e,t)};const tm="@firebase/installations",tg="0.6.4",ty=`w:${tg}`,tb="FIS_v2",tw=new ep("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});/** Returns true if error is a FirebaseError that is based on an error from the server. */function tv(e){return e instanceof eu&&e.code.includes("request-failed"/* ErrorCode.REQUEST_FAILED */)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 * @public
 */async function tZ(e,t=!1){await tX(e);// At this point we either have a Registered Installation in the DB, or we've
// already thrown an error.
let i=await tU(e,t);return i.token}async function tX(e){let{registrationPromise:t}=await tW(e);t&&await t}function t0(e){return tw.create("missing-app-config-values"/* ErrorCode.MISSING_APP_CONFIG_VALUES */,{valueName:e})}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const t1="installations";eY(new ew(t1,e=>{let t=e.getProvider("app").getImmediate(),i=/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
e("event"/* GtagCommand.EVENT */,n,a||{})}catch(e){t3.error(e)}}const ie=new /**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function is(){if(!ef())return t3.warn(t5.create("indexeddb-unavailable"/* AnalyticsError.INDEXEDDB_UNAVAILABLE */,{errorInfo:"IndexedDB is not available in this environment."}).message),!1;try{await ed()}catch(e){return t3.warn(t5.create("indexeddb-unavailable"/* AnalyticsError.INDEXEDDB_UNAVAILABLE */,{errorInfo:null==e?void 0:e.toString()}).message),!1}return!0}/**
 ...
 */async function il(e,t,i,n,r,s,l){var c;let f=ii(e);// Once fetched, map measurementIds to appId, for ease of lookup in wrapped gtag function.
f.then(t=>{i[t.measurementId]=t.appId,e.options.measurementId&&t.measurementId!==e.options.measurementId&&t3.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${t.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(e=>t3.error(e)),// Add to list to track state of all dynamic config promises.
t.push(f);let d=is().then(e=>e?n.getId():void 0),[u,p]=await Promise.all([f,d]);!/**
 ...
 */let ih="dataLayer",im=!1;const ig="@firebase/analytics",iy="0.10.0";eY(new ew(t2,(e,{options:t})=>{// getImmediate for FirebaseApp will always succeed
 ...
 *
 * @public
 */function(e=eU){let t=eG.get(e);if(!t&&e===eU&&el())return e0();if(!t)throw eZ.create("no-app"/* AppError.NO_APP */,{appName:e});return t}()){e=eb(e);// Dependencies
...
let r=o.uid,s=ref(database,"users/"+r);set(s,{name:t,email:i,password:n}).then(()=>{console.log("User data saved in the database.")}).catch(e=>{console.error("Error saving user data:",e)})}).catch(e=>{e.code;let t=e.message;console.error("Registration failed:",t)})})}),v("dGLOO");//# sourceMappingURL=index.f059ecc1.js.map

//# sourceMappingURL=index.f059ecc1.js.map
